...
function TitleBarInner({ isMaximized, setIsMaximized }: { isMaximized: boolean; setIsMaximized: (v: boolean) => void }) {
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-xl shadow-2xl w-80 border border-[#E2E8F0] dark:border-[#334155] overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                />
                <label htmlFor="rememberChoice" className="text-xs text-[#6C757B] dark:text-[#94A3B8]">记住我的选择</label>
              </div>
